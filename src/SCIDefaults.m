...
NSDictionary *SCIDefaultsDictionary(void) {
	return @{
		...
		@"sci_devicespoof_enabled": @(NO),
		@"sci_devicespoof_device_id": @"",
		@"sci_devicespoof_fdid": @"",
		@"sci_devicespoof_orig_deviceid": @"",
		@"sci_devicespoof_orig_fbdeviceid": @"",
		@"sci_devicespoof_login_button": @(YES),
		@"sci_devicespoof_block_devicecheck": @(NO),
		...
		@"sci_story_viewer_sort_enabled": @(NO),
		...
		@"igt_ip_storyviewnotify": @(NO),
		@"igt_ip_linksmedia": @(NO),
		@"igt_ip_ads_incentive_feed": @(NO),
		@"igt_ip_ads_incentive_story": @(NO),
		@"igt_ip_ads_incentive_storycaptain": @(NO),
		@"igt_ip_ads_incentive_reels": @(NO),
		@"igt_ip_ads_incentive_promo": @(NO),
		@"igt_ip_freetrial": @(NO),
		@"igt_ip_bypass_expired": @(NO),
		@"igt_ip_up_prefetch": @(NO),
		@"igt_ip_up_block_dest": @(NO),
		...
		// ===== Internal / Employee / Dogfood / Gating / MobileConfig (de experimental2) =====
		...
		@"sci_internal_gate_crash_clean_exit_session_id": @"",
		@"sci_internal_gate_crash_disabled_keys": @[],
		@"sci_internal_gate_crash_disabled_runtime_plans": @{},
		@"sci_internal_gate_crash_guard_enabled": @(YES),
		@"sci_internal_gate_crash_last_source": @"",
		@"sci_internal_gate_crash_pending_keys": @[],
		@"sci_internal_gate_crash_pending_runtime_plans": @{},
		@"sci_internal_gate_crash_session_id": @"",
		@"sci_internal_gate_crash_stable_session_id": @"",
		@"sci_internal_menus": @(NO),
		@"sci_internal_settings_availability_raw_value": @(0),
		@"sci_idnamemap_unit": @"current",
		@"sci_idnamemap_timeout": @(30),
		@"sci_idnamemap_mode": @(1),
		@"sci_mc_native_override_apply_on_launch": @(NO),
		@"sci_runtime_data_patch_snapshots": @{},
		@"sci_runtime_patch_plans": @{},
		@"sci_symbol_overrides": @{},
		@"sci_dogfooding_setting_changes": @[],
		@"sci_employee_internal": @(NO),
		@"sci_force_meta_ext_experiment": @(NO),
		@"sci_gating_direct_bool_overrides": @{},
		@"sci_gating_eval_blacklist": @[],
		@"sci_gating_eval_pending": @"",
		@"sci_launcher_overrides": @{},
		@"sci_mobileconfig_custom_overrides": @{},
		@"sci_nav_liquidglass_enabled": @(NO),
